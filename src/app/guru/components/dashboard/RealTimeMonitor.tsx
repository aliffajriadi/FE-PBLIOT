  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-gray-50 border border-gray-300 text-gray-800 py-2 pl-3 pr-8 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 cursor-pointer"
            >
      ...
      <div className="flex items-center gap-4 mt-6">
        ...
        <button className="px-6 py-2 bg-red-600 text-white font-semibold rounded-lg shadow-md hover:bg-red-700 transition duration-200">
          Tutup Sesi
        </button>
      </div>
    </div>
